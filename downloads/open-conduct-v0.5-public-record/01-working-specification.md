...
**Founder-stage launch decision — August 11, 2026:** Subject to focused legal review before the notices become active, expressly licensed original specification and explanatory material will use CC BY 4.0; code deliberately released by the project will use Apache 2.0; Conduct and Open Conduct names, marks, certification language, and official-status claims remain reserved. The launch website source repository remains private. Substantial specification, code, dataset, design, and patent-sensitive contributions remain closed until terms appropriate to the material are active. These publication choices do not settle the later OCA ownership, patent, conformance, certification, or asset-transfer questions below.
